...
/**
 * ContactMe component - Centered and responsive layout
 */
const ContactMe: React.FC = () => {
  return (
    <section
      id="Contact"
      className="py-[40px] lg:py-[40px] px-[10px] bg-white"
    >
      <div className="w-full max-w-[1150px] mx-auto bg-bg-shade p-[10px] lg:p-[80px] rounded-[40px] shadow-[0_10px_40px_rgba(0,0,0,0.05)] border border-black/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[40px] lg:gap-[60px] items-start max-w-[1100px] mx-auto">
          ...
          {/* Contact Info */}
          <div className="flex flex-col gap-[30px] bg-white p-[30px] rounded-[20px] shadow-sm w-full">
          ...
          <div className="w-full bg-white p-[30px] rounded-[20px] shadow-sm">
            <form className="flex flex-col gap-[25px]">
              ...
              <div className="mt-[10px]">
                <button className="w-full py-[16px] text-base font-semibold cursor-pointer text-center no-underline rounded-[50px] transition-all duration-300 ease-in-out border border-primary text-white bg-primary hover:bg-white hover:text-primary hover:scale-105 shadow-md">
                  Send Message
                </button>
              </div>
            </form>
